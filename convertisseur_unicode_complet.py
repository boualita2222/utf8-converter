    ...
    def hex_to_char(self, hex_str, encoding):
        try:
            ...
            if encoding == 'UTF-8':
                ...
                return bytes_data.decode('utf-16be')
            elif encoding == 'UTF-16LE':
                return bytes_data.decode('utf-16le')
            elif encoding == 'UTF-32BE':
                return bytes_data.decode('utf-32be')
            elif encoding == 'UTF-32LE':
                return bytes_data.decode('utf-32le')
            return None
        except:
            return None
        ...
        while True:
            ...
            if choice == '1':
                ...
                if char:
                    ...
                    print(f"{Fore.RED}Erreur de conversion !{Style.RESET_ALL}")
